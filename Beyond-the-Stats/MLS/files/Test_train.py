...
def main():
    ...
    if XGBClassifier is not None:
        try:
            ...
            xgb_gpu.fit(X_train, y_train_enc)
            candidates.append(("xgboost-gpu", xgb_gpu))
        except Exception:
            try:
