...
class TeamStats:
    def __init__(self, name, manager=None, players=None,
                 record="0-0-0", points=0, points_per_game=0.0,
                 position=None, home_record=None, home_points=0,
                 away_record=None, away_points=0,
                 xG=0.0, xGA=0.0, xG_difference=0.0, goals=None, goals_allowed=None, goal_diff=0):
        self.name = name
        ...
        self.xG = xG
        self.xGA = xGA
        self.xG_difference = xG_difference
        self.goals = goals
    ...
    def __repr__(self):
        return (f"Team(name='{self.name}', Manager='{self.manager}', "
                f"Player count={len(self.players)} players, Record='{self.record}', "
                ...
                f"goals_for={self.goals}, goals_allowed={self.goals_allowed}, goal_difference={self.goal_diff})")
